...
const TRANSLATIONS = {
  fr: {
    ...
    welcomeSub: "Prêt à maîtriser le WLangage ?",
    joinUs: "Rejoignez l'élite",
    joinSub: "Accédez aux meilleures ressources WinDev.",
    searchPlaceholder: "Rechercher un cours (ex: HFSQL, Mobile...)",
    popularCourses: "Formations Populaires",
  ...
  en: {
    ...
    welcomeSub: "Ready to master WLangage?",
    joinUs: "Join the Elite",
    joinSub: "Access the best WinDev resources.",
    searchPlaceholder: "Search course (e.g., HFSQL, Mobile...)",
  ...
  ar: {
    brand: "أكاديمية وينديف إكسبرت",
    login: "دخول",
    register: "تسجيل جديد",
    catalog: "الدورات التدريبية",
    navHome: "الرئيسية",
    navCategories: "التصنيفات",
    navContact: "اتصل بنا",
    myLearning: "مسار تعلمي",
    ...
    welcomeSub: "مستعد لاحتراف لغة WLangage؟",
    joinUs: "انضم إلى النخبة",
    joinSub: "احصل على أفضل موارد WinDev التعليمية.",
    searchPlaceholder: "ابحث عن دورة (مثال: HFSQL، Mobile...)",
    popularCourses: "الدورات الأكثر طلباً",
    startLearning: "ابدأ الآن",
...
const InputField = ({ icon: Icon, type, placeholder, isRTL }) => (
...
export default function WindevExpertAcademy() {
  ...
  const [view, setView] = useState('login'); // login, register, catalog, categories, player
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-10 p-6">
              <div className="bg-white/20 p-4 rounded-full backdrop-blur-sm mb-4 group-hover:bg-white/30 transition-colors duration-300 shadow-inner">
                <cat.icon size={36} className="text-white drop-shadow-md" />
              </div>
